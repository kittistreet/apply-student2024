...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3">SLC <sup>Apply</sup></div>
    </a>

    <!-- Divider -->
    <hr class="sidebar-divider my-0">

    <li class="nav-item active" id="nav-step-1">
        <a class="nav-link" href="#">
            <i class="fas fa-fw fa-folder"></i>
            <span>Accept PDPA</span>
        </a>
    </li>
    <!-- Divider -->
    ...
    <li class="nav-item" id="nav-step-2">
    ...
    <li class="nav-item" id="nav-step-3">
    ...
    <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">ตั้งค่าระบบ Admin</h6>
